...
import type { TripRouteDetailResponse } from "@/features/trip-route/types/trip-routes";
...
import { addBookmarkTripRoute } from "@/features/trip-route/api/trip-route.api";
import { useQueryClient } from "@tanstack/react-query";
import { useRouter } from "next/navigation";
import { useMutation } from "@tanstack/react-query";
import dynamic from "next/dynamic";
import { useAuthStore } from "@/features/auth/store/auth.store";
import { fetchNearbyTripRoutes } from "@/features/trip-route/api/trip-route.api";
import { SpotCategory, SpotMapResponse } from "@/features/spot/types/spots";
import { cn } from "@/shared/lib/utils";
import Link from "next/link";
import { MapPin } from "lucide-react";

const DynamicTripRouteMap = dynamic(() => import("@/features/trip-route/components/TripRouteMap"), {
  ssr: false,
